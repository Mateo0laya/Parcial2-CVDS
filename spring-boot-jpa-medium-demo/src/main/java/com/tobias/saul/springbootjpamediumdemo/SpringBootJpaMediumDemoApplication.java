...
public class SpringBootJpaMediumDemoApplication {
	...
	public CommandLineRunner run() throws Exception {
		return (args) -> {
			...
			employeeService.addEmployee(new Employee("Mateo", "Olaya", "Estudiante", 0.00, LocalDate.of(2003, 4, 26)));
			employeeService.addEmployee(new Employee("Jorge", "Useche", "Profesor", 9999999.00, LocalDate.of(190, 9, 16)));
